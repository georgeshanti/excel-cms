...
/**
 * A set of functions called "actions" for `day_one`
 */
...
module.exports = {
  ...
  /**
   * Add an entry to a specific day_one.
   *
   * @return {Object}
   */
  ...
  /**
   * Remove a specific entry from a specific day_one.
   *
   * @return {Object}
   */
