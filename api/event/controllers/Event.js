...
/**
 * A set of functions called "actions" for `event`
 */
...
module.exports = {
  ...
  /**
   * Add an entry to a specific event.
   *
   * @return {Object}
   */
  ...
  /**
   * Remove a specific entry from a specific event.
   *
   * @return {Object}
   */
