...
/**
 * A set of functions called "actions" for `sponsor`
 */
...
module.exports = {
  ...
  /**
   * Add an entry to a specific sponsor.
   *
   * @return {Object}
   */
  ...
  /**
   * Remove a specific entry from a specific sponsor.
   *
   * @return {Object}
   */
