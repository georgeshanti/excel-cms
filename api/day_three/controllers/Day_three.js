...
const model = 'day_three';

/**
 * A set of functions called "actions" for `day_three`
 */

module.exports = {

  /**
   * Get day_three entries.
   *
   * @return {Object|Array}
   */
  ...
  /**
   * Add an entry to a specific day_three.
   *
   * @return {Object}
   */
  ...
  /**
   * Remove a specific entry from a specific day_three.
   *
   * @return {Object}
   */
