...
/**
 * A set of functions called "actions" for `newsfeed`
 */
...
module.exports = {
  ...
  /**
   * Add an entry to a specific newsfeed.
   *
   * @return {Object}
   */
  ...
  /**
   * Remove a specific entry from a specific newsfeed.
   *
   * @return {Object}
   */
