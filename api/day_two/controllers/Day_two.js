...
/**
 * A set of functions called "actions" for `day_two`
 */
...
module.exports = {
  ...
  /**
   * Add an entry to a specific day_two.
   *
   * @return {Object}
   */
  ...
  /**
   * Remove a specific entry from a specific day_two.
   *
   * @return {Object}
   */
